...
class LibraryFunc:
    ...
    # Используются параметризованные запросы, чтобы избежать sql-инъекций.
    
    def __init__(self, db_name):
        """
        Инициализаия подключения к базе данных и создание таблицы книг, если она не существует.
    ...
    def search_books(self, keyword):
        ...
        Arguments:
            keyword (str): Ключевое слово для поиска в названии книги или имени автора.
        """
        # Разделение ключевого слова на отдельные слова
        ...
        query = '''SELECT * FROM books WHERE {}'''.format(' AND '.join(conditions))
